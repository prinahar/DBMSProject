...
public class UserDao {
	...
	// Input: person, List of Cuisines, List of restrictions that already in
	// database.
	// Effect: add a user into database. orders field will be set to null when
	// user created.
	// the user field of Person, the users field of Cuisine and Restriction
	// should be
	// set automatically by JPA
	// this function is called with addPayment in PaymentDao, the payment field
	// of User
	...
	public static void main(String[] args) {
		...
		// Person p = new Person("alice", "user", "alice", "wonderland",
		// "123321", null, null);
		// Person p2 = new Person("bob2", "user", "bob2", "bob2", "123321",
		// null, null);
